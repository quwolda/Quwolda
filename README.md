...
###
> Я студент колледжа, программист-самоучка. Каюсь, использую ИИ, но лишь из-за того что не могу себе позволить расточительное количество времени и денег провести за изучением языков программирования. Но это не значит что я не знаю никакой.
###
